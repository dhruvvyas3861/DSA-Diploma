/*
2. Write a menu-driven program to implement the following operations on the singly linked list: (A)
i. Insert a node at the beginning of the linked list.
ii. Insert a node at the end of the linked list.
iii. Delete a ƒrst node of the linked list.
iv. Delete a last node of the linked list.
v. Display all nodes
*/
#include<stdio.h>
#include<stdlib.h>
